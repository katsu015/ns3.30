...
#include "ns3/bhattackdsr-module.h"
#include <sstream>
...
{
      std::string animFile = "dsranim11.xml";
  //
...
#if 0
  LogComponentEnable ("BhattackdsrOptions", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrHelper", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrRouting", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrOptionHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrFsHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrGraReplyTable", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrSendBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrRouteCache", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrMaintainBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrRreqTable", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrErrorBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("BhattackdsrNetworkQueue", LOG_LEVEL_ALL);
#endif
  ...
  */
  ...
  BhattackdsrMainHelper dsrMain;
  BhattackdsrHelper dsr;
  ...
  wifiPhy.EnablePcapAll("bhattackdsrp");
  Simulator::Run ();
  Simulator::Destroy ();
}
