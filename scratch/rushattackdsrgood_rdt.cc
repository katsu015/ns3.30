...
#include "ns3/rushattackdsr-module.h"
#include <sstream>
...
NS_LOG_COMPONENT_DEFINE ("rushattackdsrTest");

int
main (int argc, char *argv[])
{
      std::string animFile = "rushattackdsranim.xml";
  //
...
#if 0
  LogComponentEnable ("YoungrushattackdsrOptions", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrHelper", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrRouting", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrOptionHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrFsHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrGraReplyTable", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrSendBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrRouteCache", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrMaintainBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrRreqTable", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrErrorBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungrushattackdsrNetworkQueue", LOG_LEVEL_ALL);
#endif
  ...
  Ptr<OutputStreamWrapper> stream = ascii.CreateFileStream ("rushattackdsrtest.tr");
  ...
  Ptr<RandomRectanglePositionAllocator> posList = CreateObject<RandomRectanglePositionAllocator> ();
  */
  ...
  RushattackdsrMainHelper rushattackdsrMain;
  RushattackdsrHelper rushattackdsr;
  internet.Install (adhocNodes);
  rushattackdsrMain.Install (rushattackdsr, adhocNodes);
