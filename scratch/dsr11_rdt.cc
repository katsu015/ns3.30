...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("YoungdsrOptionHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungdsrFsHeader", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungdsrGraReplyTable", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungdsrSendBuffer", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungdsrRouteCache", LOG_LEVEL_ALL);
  LogComponentEnable ("YoungdsrMaintainBuffer", LOG_LEVEL_ALL);
  ...
  */
  ...
  wifiPhy.EnablePcapAll("dsr11_rdtp");
  Simulator::Run ();
  Simulator::Destroy ();
}
