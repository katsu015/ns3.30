...
def module_init():
    root_module = Module('ns.youngdsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## youngdsr-helper.h (module 'youngdsr'): ns3::YoungdsrHelper [class]
    module.add_class('YoungdsrHelper')
    ## youngdsr-main-helper.h (module 'youngdsr'): ns3::YoungdsrMainHelper [class]
    module.add_class('YoungdsrMainHelper')
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', template_parameters=['void', 'const ns3::youngdsr::YoungdsrOptionSRHeader &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'], parent=root_module['ns3::CallbackImplBase'])
    ...
    ## Register a nested module for the namespace youngdsr
    
    nested_module = module.add_cpp_namespace('youngdsr')
    register_types_ns3_youngdsr(nested_module)
...
def register_types_ns3_youngdsr(module):
    root_module = module.get_root()
    
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::LinkStates [enumeration]
    module.add_enum('LinkStates', ['PROBABLE', 'QUESTIONABLE'])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMessageType [enumeration]
    module.add_enum('YoungdsrMessageType', ['DSR_CONTROL_PACKET', 'DSR_DATA_PACKET'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::ErrorType [enumeration]
    module.add_enum('ErrorType', ['NODE_UNREACHABLE', 'FLOW_STATE_NOT_SUPPORTED', 'OPTION_NOT_SUPPORTED'])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList [struct]
    module.add_class('BlackList')
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffEntry [class]
    module.add_class('YoungdsrErrorBuffEntry')
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffer [class]
    module.add_class('YoungdsrErrorBuffer')
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrFsHeader [class]
    module.add_class('YoungdsrFsHeader', parent=root_module['ns3::Header'])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrGraReply [class]
    module.add_class('YoungdsrGraReply', parent=root_module['ns3::Object'])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrLinkStab [class]
    module.add_class('YoungdsrLinkStab')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffEntry [class]
    module.add_class('YoungdsrMaintainBuffEntry')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffer [class]
    module.add_class('YoungdsrMaintainBuffer')
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueue [class]
    module.add_class('YoungdsrNetworkQueue', parent=root_module['ns3::Object'])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueueEntry [class]
    module.add_class('YoungdsrNetworkQueueEntry')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNodeStab [class]
    module.add_class('YoungdsrNodeStab')
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionField [class]
    module.add_class('YoungdsrOptionField')
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader [class]
    module.add_class('YoungdsrOptionHeader', parent=root_module['ns3::Header'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment [struct]
    module.add_class('Alignment', outer_class=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1Header [class]
    module.add_class('YoungdsrOptionPad1Header', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadnHeader [class]
    module.add_class('YoungdsrOptionPadnHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrHeader [class]
    module.add_class('YoungdsrOptionRerrHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnreachHeader [class]
    module.add_class('YoungdsrOptionRerrUnreachHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionRerrHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader [class]
    module.add_class('YoungdsrOptionRerrUnsupportHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionRerrHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrepHeader [class]
    module.add_class('YoungdsrOptionRrepHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreqHeader [class]
    module.add_class('YoungdsrOptionRreqHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSRHeader [class]
    module.add_class('YoungdsrOptionSRHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    typehandlers.add_type_alias(u'void ( * ) ( ns3::youngdsr::YoungdsrOptionSRHeader const & )', u'ns3::youngdsr::YoungdsrOptionSRHeader::TracedCallback')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::youngdsr::YoungdsrOptionSRHeader const & )*', u'ns3::youngdsr::YoungdsrOptionSRHeader::TracedCallback*')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::youngdsr::YoungdsrOptionSRHeader const & )&', u'ns3::youngdsr::YoungdsrOptionSRHeader::TracedCallback&')
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptions [class]
    module.add_class('YoungdsrOptions', parent=root_module['ns3::Object'])
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffEntry [class]
    module.add_class('YoungdsrPassiveBuffEntry')
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffer [class]
    module.add_class('YoungdsrPassiveBuffer', parent=root_module['ns3::Object'])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrReceivedRreqEntry [class]
    module.add_class('YoungdsrReceivedRreqEntry')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache [class]
    module.add_class('YoungdsrRouteCache', parent=root_module['ns3::Object'])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::youngdsr::YoungdsrRouteCache'])
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >', u'ns3::youngdsr::YoungdsrRouteCache::routeVector')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >*', u'ns3::youngdsr::YoungdsrRouteCache::routeVector*')
    typehandlers.add_type_alias(u'std::list< std::vector< ns3::Ipv4Address > >&', u'ns3::youngdsr::YoungdsrRouteCache::routeVector&')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCacheEntry [class]
    module.add_class('YoungdsrRouteCacheEntry')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >', u'ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >*', u'ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address >&', u'ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR&')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator', u'ns3::youngdsr::YoungdsrRouteCacheEntry::Iterator')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator*', u'ns3::youngdsr::YoungdsrRouteCacheEntry::Iterator*')
    typehandlers.add_type_alias(u'std::vector< ns3::Ipv4Address > iterator&', u'ns3::youngdsr::YoungdsrRouteCacheEntry::Iterator&')
    ## youngdsr-routing.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouting [class]
    module.add_class('YoungdsrRouting', parent=root_module['ns3::IpL4Protocol'])
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRoutingHeader [class]
    module.add_class('YoungdsrRoutingHeader', parent=[root_module['ns3::youngdsr::YoungdsrFsHeader'], root_module['ns3::youngdsr::YoungdsrOptionField']])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRreqTable [class]
    module.add_class('YoungdsrRreqTable', parent=root_module['ns3::Object'])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffEntry [class]
    module.add_class('YoungdsrSendBuffEntry')
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffer [class]
    module.add_class('YoungdsrSendBuffer')
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry [struct]
    module.add_class('GraReplyEntry')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::Link [struct]
    module.add_class('Link')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey [struct]
    module.add_class('LinkKey')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey [struct]
    module.add_class('NetworkKey')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey [struct]
    module.add_class('PassiveKey')
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::RreqTableEntry [struct]
    module.add_class('RreqTableEntry')
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAck [class]
    module.add_class('YoungdsrOptionAck', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckHeader [class]
    module.add_class('YoungdsrOptionAckHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReq [class]
    module.add_class('YoungdsrOptionAckReq', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReqHeader [class]
    module.add_class('YoungdsrOptionAckReqHeader', parent=root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1 [class]
    module.add_class('YoungdsrOptionPad1', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadn [class]
    module.add_class('YoungdsrOptionPadn', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerr [class]
    module.add_class('YoungdsrOptionRerr', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrep [class]
    module.add_class('YoungdsrOptionRrep', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreq [class]
    module.add_class('YoungdsrOptionRreq', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSR [class]
    module.add_class('YoungdsrOptionSR', parent=root_module['ns3::youngdsr::YoungdsrOptions'])
    module.add_container('std::vector< ns3::youngdsr::YoungdsrErrorBuffEntry >', 'ns3::youngdsr::YoungdsrErrorBuffEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::youngdsr::YoungdsrNetworkQueueEntry >', 'ns3::youngdsr::YoungdsrNetworkQueueEntry', container_type=u'vector')
    module.add_container('std::vector< ns3::Ipv4Address >', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::list< ns3::youngdsr::YoungdsrRouteCacheEntry >', 'ns3::youngdsr::YoungdsrRouteCacheEntry', container_type=u'list')
    module.add_container('std::list< std::vector< ns3::Ipv4Address > >', 'std::vector< ns3::Ipv4Address >', container_type=u'list')
    module.add_container('ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::vector< ns3::youngdsr::YoungdsrRouteCache::Neighbor >', 'ns3::youngdsr::YoungdsrRouteCache::Neighbor', container_type=u'vector')
    ...
    module.add_container('std::vector< ns3::youngdsr::YoungdsrSendBuffEntry >', 'ns3::youngdsr::YoungdsrSendBuffEntry', container_type=u'vector')
...
def register_methods(root_module):
    ...
    register_Ns3YoungdsrHelper_methods(root_module, root_module['ns3::YoungdsrHelper'])
    register_Ns3YoungdsrMainHelper_methods(root_module, root_module['ns3::YoungdsrMainHelper'])
    ...
    register_Ns3CallbackImpl__Void_Const_ns3YoungdsrYoungdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3YoungdsrBlackList_methods(root_module, root_module['ns3::youngdsr::BlackList'])
    register_Ns3YoungdsrYoungdsrErrorBuffEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrErrorBuffEntry'])
    register_Ns3YoungdsrYoungdsrErrorBuffer_methods(root_module, root_module['ns3::youngdsr::YoungdsrErrorBuffer'])
    register_Ns3YoungdsrYoungdsrFsHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrFsHeader'])
    register_Ns3YoungdsrYoungdsrGraReply_methods(root_module, root_module['ns3::youngdsr::YoungdsrGraReply'])
    register_Ns3YoungdsrYoungdsrLinkStab_methods(root_module, root_module['ns3::youngdsr::YoungdsrLinkStab'])
    register_Ns3YoungdsrYoungdsrMaintainBuffEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrMaintainBuffEntry'])
    register_Ns3YoungdsrYoungdsrMaintainBuffer_methods(root_module, root_module['ns3::youngdsr::YoungdsrMaintainBuffer'])
    register_Ns3YoungdsrYoungdsrNetworkQueue_methods(root_module, root_module['ns3::youngdsr::YoungdsrNetworkQueue'])
    register_Ns3YoungdsrYoungdsrNetworkQueueEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrNetworkQueueEntry'])
    register_Ns3YoungdsrYoungdsrNodeStab_methods(root_module, root_module['ns3::youngdsr::YoungdsrNodeStab'])
    register_Ns3YoungdsrYoungdsrOptionField_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionField'])
    register_Ns3YoungdsrYoungdsrOptionHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionHeader'])
    register_Ns3YoungdsrYoungdsrOptionHeaderAlignment_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionHeader::Alignment'])
    register_Ns3YoungdsrYoungdsrOptionPad1Header_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionPad1Header'])
    register_Ns3YoungdsrYoungdsrOptionPadnHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionPadnHeader'])
    register_Ns3YoungdsrYoungdsrOptionRerrHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRerrHeader'])
    register_Ns3YoungdsrYoungdsrOptionRerrUnreachHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRerrUnreachHeader'])
    register_Ns3YoungdsrYoungdsrOptionRerrUnsupportHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader'])
    register_Ns3YoungdsrYoungdsrOptionRrepHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRrepHeader'])
    register_Ns3YoungdsrYoungdsrOptionRreqHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRreqHeader'])
    register_Ns3YoungdsrYoungdsrOptionSRHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionSRHeader'])
    register_Ns3YoungdsrYoungdsrOptions_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptions'])
    register_Ns3YoungdsrYoungdsrPassiveBuffEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrPassiveBuffEntry'])
    register_Ns3YoungdsrYoungdsrPassiveBuffer_methods(root_module, root_module['ns3::youngdsr::YoungdsrPassiveBuffer'])
    register_Ns3YoungdsrYoungdsrReceivedRreqEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrReceivedRreqEntry'])
    register_Ns3YoungdsrYoungdsrRouteCache_methods(root_module, root_module['ns3::youngdsr::YoungdsrRouteCache'])
    register_Ns3YoungdsrYoungdsrRouteCacheNeighbor_methods(root_module, root_module['ns3::youngdsr::YoungdsrRouteCache::Neighbor'])
    register_Ns3YoungdsrYoungdsrRouteCacheEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrRouteCacheEntry'])
    register_Ns3YoungdsrYoungdsrRouting_methods(root_module, root_module['ns3::youngdsr::YoungdsrRouting'])
    register_Ns3YoungdsrYoungdsrRoutingHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrRoutingHeader'])
    register_Ns3YoungdsrYoungdsrRreqTable_methods(root_module, root_module['ns3::youngdsr::YoungdsrRreqTable'])
    register_Ns3YoungdsrYoungdsrSendBuffEntry_methods(root_module, root_module['ns3::youngdsr::YoungdsrSendBuffEntry'])
    register_Ns3YoungdsrYoungdsrSendBuffer_methods(root_module, root_module['ns3::youngdsr::YoungdsrSendBuffer'])
    register_Ns3YoungdsrGraReplyEntry_methods(root_module, root_module['ns3::youngdsr::GraReplyEntry'])
    register_Ns3YoungdsrLink_methods(root_module, root_module['ns3::youngdsr::Link'])
    register_Ns3YoungdsrLinkKey_methods(root_module, root_module['ns3::youngdsr::LinkKey'])
    register_Ns3YoungdsrNetworkKey_methods(root_module, root_module['ns3::youngdsr::NetworkKey'])
    register_Ns3YoungdsrPassiveKey_methods(root_module, root_module['ns3::youngdsr::PassiveKey'])
    register_Ns3YoungdsrRreqTableEntry_methods(root_module, root_module['ns3::youngdsr::RreqTableEntry'])
    register_Ns3YoungdsrYoungdsrOptionAck_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionAck'])
    register_Ns3YoungdsrYoungdsrOptionAckHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionAckHeader'])
    register_Ns3YoungdsrYoungdsrOptionAckReq_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionAckReq'])
    register_Ns3YoungdsrYoungdsrOptionAckReqHeader_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionAckReqHeader'])
    register_Ns3YoungdsrYoungdsrOptionPad1_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionPad1'])
    register_Ns3YoungdsrYoungdsrOptionPadn_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionPadn'])
    register_Ns3YoungdsrYoungdsrOptionRerr_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRerr'])
    register_Ns3YoungdsrYoungdsrOptionRrep_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRrep'])
    register_Ns3YoungdsrYoungdsrOptionRreq_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionRreq'])
    register_Ns3YoungdsrYoungdsrOptionSR_methods(root_module, root_module['ns3::youngdsr::YoungdsrOptionSR'])
    return
...
def register_Ns3YoungdsrHelper_methods(root_module, cls):
    ## youngdsr-helper.h (module 'youngdsr'): ns3::YoungdsrHelper::YoungdsrHelper() [constructor]
    cls.add_constructor([])
    ## youngdsr-helper.h (module 'youngdsr'): ns3::YoungdsrHelper::YoungdsrHelper(ns3::YoungdsrHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::YoungdsrHelper const &', 'arg0')])
    ## youngdsr-helper.h (module 'youngdsr'): ns3::YoungdsrHelper * ns3::YoungdsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::YoungdsrHelper *', 
                   [], 
                   is_const=True)
    ## youngdsr-helper.h (module 'youngdsr'): ns3::Ptr<ns3::youngdsr::YoungdsrRouting> ns3::YoungdsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::youngdsr::YoungdsrRouting >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## youngdsr-helper.h (module 'youngdsr'): void ns3::YoungdsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return

def register_Ns3YoungdsrMainHelper_methods(root_module, cls):
    ## youngdsr-main-helper.h (module 'youngdsr'): ns3::YoungdsrMainHelper::YoungdsrMainHelper() [constructor]
    cls.add_constructor([])
    ## youngdsr-main-helper.h (module 'youngdsr'): ns3::YoungdsrMainHelper::YoungdsrMainHelper(ns3::YoungdsrMainHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::YoungdsrMainHelper const &', 'arg0')])
    ## youngdsr-main-helper.h (module 'youngdsr'): void ns3::YoungdsrMainHelper::Install(ns3::YoungdsrHelper & youngdsrHelper, ns3::NodeContainer nodes) [member function]
    cls.add_method('Install', 
                   'void', 
                   [param('ns3::YoungdsrHelper &', 'youngdsrHelper'), param('ns3::NodeContainer', 'nodes')])
    ## youngdsr-main-helper.h (module 'youngdsr'): void ns3::YoungdsrMainHelper::SetYoungdsrHelper(ns3::YoungdsrHelper & youngdsrHelper) [member function]
    cls.add_method('SetYoungdsrHelper', 
                   'void', 
                   [param('ns3::YoungdsrHelper &', 'youngdsrHelper')])
    return
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, visibility='protected', template_parameters=[u'ns3::youngdsr::YoungdsrOptionSRHeader const&'])
    return
...
def register_Ns3CallbackImpl__Void_Const_ns3YoungdsrYoungdsrOptionSRHeader___amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::youngdsr::YoungdsrOptionSRHeader const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, const ns3::youngdsr::YoungdsrOptionSRHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::youngdsr::YoungdsrOptionSRHeader const & arg0) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrOptionSRHeader const &', 'arg0')], 
                   is_pure_virtual=True, is_virtual=True, custom_name=u'__call__')
    return
...
def register_Ns3YoungdsrBlackList_methods(root_module, cls):
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList::BlackList(ns3::youngdsr::BlackList const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::BlackList const &', 'arg0')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList::BlackList(ns3::Ipv4Address ip, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Time', 't')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList::m_linkStates [variable]
    cls.add_instance_attribute('m_linkStates', 'ns3::youngdsr::LinkStates', is_const=False)
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrYoungdsrErrorBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffEntry::YoungdsrErrorBuffEntry(ns3::youngdsr::YoungdsrErrorBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrErrorBuffEntry const &', 'arg0')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffEntry::YoungdsrErrorBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrErrorBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrErrorBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrErrorBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Ptr<const ns3::Packet> ns3::youngdsr::YoungdsrErrorBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrErrorBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrErrorBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3YoungdsrYoungdsrErrorBuffer_methods(root_module, cls):
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffer::YoungdsrErrorBuffer(ns3::youngdsr::YoungdsrErrorBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrErrorBuffer const &', 'arg0')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrErrorBuffer::YoungdsrErrorBuffer() [constructor]
    cls.add_constructor([])
    ## youngdsr-errorbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrErrorBuffer::Dequeue(ns3::Ipv4Address dst, ns3::youngdsr::YoungdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::youngdsr::YoungdsrErrorBuffEntry &', 'entry')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffer::DropPacketForErrLink(ns3::Ipv4Address source, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketForErrLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrErrorBuffer::Enqueue(ns3::youngdsr::YoungdsrErrorBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrErrorBuffEntry &', 'entry')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrErrorBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): std::vector<ns3::youngdsr::YoungdsrErrorBuffEntry, std::allocator<ns3::youngdsr::YoungdsrErrorBuffEntry> > & ns3::youngdsr::YoungdsrErrorBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::youngdsr::YoungdsrErrorBuffEntry > &', 
                   [])
    ## youngdsr-errorbuff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrErrorBuffer::GetErrorBufferTimeout() const [member function]
    cls.add_method('GetErrorBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrErrorBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-errorbuff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrErrorBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffer::SetErrorBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetErrorBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## youngdsr-errorbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrErrorBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3YoungdsrYoungdsrFsHeader_methods(root_module, cls):
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrFsHeader::YoungdsrFsHeader(ns3::youngdsr::YoungdsrFsHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrFsHeader const &', 'arg0')])
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrFsHeader::YoungdsrFsHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrFsHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrFsHeader::GetDestId() const [member function]
    cls.add_method('GetDestId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrFsHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrFsHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrFsHeader::GetNextHeader() const [member function]
    cls.add_method('GetNextHeader', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrFsHeader::GetPayloadLength() const [member function]
    cls.add_method('GetPayloadLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrFsHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrFsHeader::GetSourceId() const [member function]
    cls.add_method('GetSourceId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrFsHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::SetDestId(uint16_t destId) [member function]
    cls.add_method('SetDestId', 
                   'void', 
                   [param('uint16_t', 'destId')])
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::SetMessageType(uint8_t messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('uint8_t', 'messageType')])
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::SetNextHeader(uint8_t protocol) [member function]
    cls.add_method('SetNextHeader', 
                   'void', 
                   [param('uint8_t', 'protocol')])
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::SetPayloadLength(uint16_t length) [member function]
    cls.add_method('SetPayloadLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrFsHeader::SetSourceId(uint16_t sourceId) [member function]
    cls.add_method('SetSourceId', 
                   'void', 
                   [param('uint16_t', 'sourceId')])
    return

def register_Ns3YoungdsrYoungdsrGraReply_methods(root_module, cls):
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrGraReply::YoungdsrGraReply(ns3::youngdsr::YoungdsrGraReply const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrGraReply const &', 'arg0')])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrGraReply::YoungdsrGraReply() [constructor]
    cls.add_constructor([])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrGraReply::AddEntry(ns3::youngdsr::GraReplyEntry & graTableEntry) [member function]
    cls.add_method('AddEntry', 
                   'bool', 
                   [param('ns3::youngdsr::GraReplyEntry &', 'graTableEntry')])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrGraReply::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrGraReply::FindAndUpdate(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, ns3::Time gratReplyHoldoff) [member function]
    ...
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrGraReply::GetGraTableSize() const [member function]
    cls.add_method('GetGraTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrGraReply::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrGraReply::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrGraReply::SetGraTableSize(uint32_t g) [member function]
    cls.add_method('SetGraTableSize', 
                   'void', 
                   [param('uint32_t', 'g')])
    return

def register_Ns3YoungdsrYoungdsrLinkStab_methods(root_module, cls):
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrLinkStab::YoungdsrLinkStab(ns3::youngdsr::YoungdsrLinkStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrLinkStab const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrLinkStab::YoungdsrLinkStab(ns3::Time linkStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'linkStab', default_value='ns3::Simulator::Now()')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrLinkStab::GetLinkStability() const [member function]
    cls.add_method('GetLinkStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrLinkStab::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrLinkStab::SetLinkStability(ns3::Time linkStab) [member function]
    cls.add_method('SetLinkStability', 
                   'void', 
                   [param('ns3::Time', 'linkStab')])
    return

def register_Ns3YoungdsrYoungdsrMaintainBuffEntry_methods(root_module, cls):
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffEntry::YoungdsrMaintainBuffEntry(ns3::youngdsr::YoungdsrMaintainBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrMaintainBuffEntry const &', 'arg0')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffEntry::YoungdsrMaintainBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address us=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address dst=ns3::Ipv4Address(), uint16_t ackId=0, uint8_t segs=0, ns3::Time exp=ns3::Simulator::Now()) [constructor]
    ...
    ## youngdsr-maintain-buff.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrMaintainBuffEntry::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrMaintainBuffEntry::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrMaintainBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrMaintainBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrMaintainBuffEntry::GetOurAdd() const [member function]
    cls.add_method('GetOurAdd', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Ptr<const ns3::Packet> ns3::youngdsr::YoungdsrMaintainBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrMaintainBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrMaintainBuffEntry::GetSrc() const [member function]
    cls.add_method('GetSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetAckId(uint16_t ackId) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'ackId')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetDst(ns3::Ipv4Address n) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetOurAdd(ns3::Ipv4Address us) [member function]
    cls.add_method('SetOurAdd', 
                   'void', 
                   [param('ns3::Ipv4Address', 'us')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetSegsLeft(uint8_t segs) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'segs')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffEntry::SetSrc(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3YoungdsrYoungdsrMaintainBuffer_methods(root_module, cls):
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffer::YoungdsrMaintainBuffer(ns3::youngdsr::YoungdsrMaintainBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrMaintainBuffer const &', 'arg0')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrMaintainBuffer::YoungdsrMaintainBuffer() [constructor]
    cls.add_constructor([])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::AllEqual(ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::Dequeue(ns3::Ipv4Address dst, ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffer::DropPacketWithNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('DropPacketWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::Enqueue(ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrMaintainBuffer::GetMaintainBufferTimeout() const [member function]
    cls.add_method('GetMaintainBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrMaintainBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrMaintainBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::LinkEqual(ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('LinkEqual', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::NetworkEqual(ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('NetworkEqual', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrMaintainBuffer::PromiscEqual(ns3::youngdsr::YoungdsrMaintainBuffEntry & entry) [member function]
    cls.add_method('PromiscEqual', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'entry')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffer::SetMaintainBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetMaintainBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrMaintainBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    return

def register_Ns3YoungdsrYoungdsrNetworkQueue_methods(root_module, cls):
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueue::YoungdsrNetworkQueue(ns3::youngdsr::YoungdsrNetworkQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrNetworkQueue const &', 'arg0')])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueue::YoungdsrNetworkQueue() [constructor]
    cls.add_constructor([])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueue::YoungdsrNetworkQueue(uint32_t maxLen, ns3::Time maxDelay) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'maxDelay')])
    ## youngdsr-network-queue.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrNetworkQueue::Dequeue(ns3::youngdsr::YoungdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrNetworkQueueEntry &', 'entry')])
    ## youngdsr-network-queue.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrNetworkQueue::Enqueue(ns3::youngdsr::YoungdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrNetworkQueueEntry &', 'entry')])
    ## youngdsr-network-queue.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrNetworkQueue::Find(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-network-queue.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrNetworkQueue::FindPacketWithNexthop(ns3::Ipv4Address nextHop, ns3::youngdsr::YoungdsrNetworkQueueEntry & entry) [member function]
    cls.add_method('FindPacketWithNexthop', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::youngdsr::YoungdsrNetworkQueueEntry &', 'entry')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueue::Flush() [member function]
    cls.add_method('Flush', 
                   'void', 
                   [])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrNetworkQueue::GetMaxNetworkDelay() const [member function]
    cls.add_method('GetMaxNetworkDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrNetworkQueue::GetMaxNetworkSize() const [member function]
    cls.add_method('GetMaxNetworkSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): std::vector<ns3::youngdsr::YoungdsrNetworkQueueEntry, std::allocator<ns3::youngdsr::YoungdsrNetworkQueueEntry> > & ns3::youngdsr::YoungdsrNetworkQueue::GetQueue() [member function]
    cls.add_method('GetQueue', 
                   'std::vector< ns3::youngdsr::YoungdsrNetworkQueueEntry > &', 
                   [])
    ## youngdsr-network-queue.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrNetworkQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-network-queue.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrNetworkQueue::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueue::SetMaxNetworkDelay(ns3::Time delay) [member function]
    cls.add_method('SetMaxNetworkDelay', 
                   'void', 
                   [param('ns3::Time', 'delay')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueue::SetMaxNetworkSize(uint32_t maxSize) [member function]
    cls.add_method('SetMaxNetworkSize', 
                   'void', 
                   [param('uint32_t', 'maxSize')])
    return

def register_Ns3YoungdsrYoungdsrNetworkQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueueEntry::YoungdsrNetworkQueueEntry(ns3::youngdsr::YoungdsrNetworkQueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrNetworkQueueEntry const &', 'arg0')])
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNetworkQueueEntry::YoungdsrNetworkQueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), ns3::Ptr<ns3::Ipv4Route> r=0) [constructor]
    ...
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrNetworkQueueEntry::GetInsertedTimeStamp() const [member function]
    cls.add_method('GetInsertedTimeStamp', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::youngdsr::YoungdsrNetworkQueueEntry::GetIpv4Route() const [member function]
    cls.add_method('GetIpv4Route', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrNetworkQueueEntry::GetNextHopAddress() const [member function]
    cls.add_method('GetNextHopAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Ptr<const ns3::Packet> ns3::youngdsr::YoungdsrNetworkQueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrNetworkQueueEntry::GetSourceAddress() const [member function]
    cls.add_method('GetSourceAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueueEntry::SetInsertedTimeStamp(ns3::Time time) [member function]
    cls.add_method('SetInsertedTimeStamp', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueueEntry::SetIpv4Route(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetIpv4Route', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueueEntry::SetNextHopAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNextHopAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## youngdsr-network-queue.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNetworkQueueEntry::SetSourceAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('SetSourceAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr')])
    return

def register_Ns3YoungdsrYoungdsrNodeStab_methods(root_module, cls):
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNodeStab::YoungdsrNodeStab(ns3::youngdsr::YoungdsrNodeStab const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrNodeStab const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrNodeStab::YoungdsrNodeStab(ns3::Time nodeStab=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Time', 'nodeStab', default_value='ns3::Simulator::Now()')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrNodeStab::GetNodeStability() const [member function]
    cls.add_method('GetNodeStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrNodeStab::SetNodeStability(ns3::Time nodeStab) [member function]
    cls.add_method('SetNodeStability', 
                   'void', 
                   [param('ns3::Time', 'nodeStab')])
    return

def register_Ns3YoungdsrYoungdsrOptionField_methods(root_module, cls):
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionField::YoungdsrOptionField(ns3::youngdsr::YoungdsrOptionField const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionField const &', 'arg0')])
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionField::YoungdsrOptionField(uint32_t optionsOffset) [constructor]
    cls.add_constructor([param('uint32_t', 'optionsOffset')])
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionField::AddYoungdsrOption(ns3::youngdsr::YoungdsrOptionHeader const & option) [member function]
    cls.add_method('AddYoungdsrOption', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrOptionHeader const &', 'option')])
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionField::Deserialize(ns3::Buffer::Iterator start, uint32_t length) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'length')])
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::Buffer ns3::youngdsr::YoungdsrOptionField::GetYoungdsrOptionBuffer() [member function]
    cls.add_method('GetYoungdsrOptionBuffer', 
                   'ns3::Buffer', 
                   [])
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionField::GetYoungdsrOptionsOffset() [member function]
    cls.add_method('GetYoungdsrOptionsOffset', 
                   'uint32_t', 
                   [])
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionField::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionField::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
...
def register_Ns3YoungdsrYoungdsrOptionHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::YoungdsrOptionHeader(ns3::youngdsr::YoungdsrOptionHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::YoungdsrOptionHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionHeader::GetLength() const [member function]
    cls.add_method('GetLength', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionHeader::GetType() const [member function]
    cls.add_method('GetType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionHeader::SetLength(uint8_t length) [member function]
    cls.add_method('SetLength', 
                   'void', 
                   [param('uint8_t', 'length')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionHeader::SetType(uint8_t type) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('uint8_t', 'type')])
    return

def register_Ns3YoungdsrYoungdsrOptionHeaderAlignment_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment::Alignment() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment::Alignment(ns3::youngdsr::YoungdsrOptionHeader::Alignment const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionHeader::Alignment const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment::factor [variable]
    cls.add_instance_attribute('factor', 'uint8_t', is_const=False)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment::offset [variable]
    cls.add_instance_attribute('offset', 'uint8_t', is_const=False)
    return

def register_Ns3YoungdsrYoungdsrOptionPad1Header_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1Header::YoungdsrOptionPad1Header(ns3::youngdsr::YoungdsrOptionPad1Header const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionPad1Header const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1Header::YoungdsrOptionPad1Header() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionPad1Header::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionPad1Header::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionPad1Header::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionPad1Header::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionPad1Header::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionPad1Header::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3YoungdsrYoungdsrOptionPadnHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadnHeader::YoungdsrOptionPadnHeader(ns3::youngdsr::YoungdsrOptionPadnHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionPadnHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadnHeader::YoungdsrOptionPadnHeader(uint32_t pad=2) [constructor]
    cls.add_constructor([param('uint32_t', 'pad', default_value='2')])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionPadnHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionPadnHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionPadnHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionPadnHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionPadnHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionPadnHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3YoungdsrYoungdsrOptionRerrHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrHeader::YoungdsrOptionRerrHeader(ns3::youngdsr::YoungdsrOptionRerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRerrHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrHeader::YoungdsrOptionRerrHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionRerrHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerrHeader::GetErrorType() const [member function]
    cls.add_method('GetErrorType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerrHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::SetErrorType(uint8_t errorType) [member function]
    cls.add_method('SetErrorType', 
                   'void', 
                   [param('uint8_t', 'errorType')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrHeader::SetSalvage(uint8_t salvage) [member function]
...
def register_Ns3YoungdsrYoungdsrOptionRerrUnreachHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::YoungdsrOptionRerrUnreachHeader(ns3::youngdsr::YoungdsrOptionRerrUnreachHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRerrUnreachHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::YoungdsrOptionRerrUnreachHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetOriginalDst() const [member function]
    cls.add_method('GetOriginalDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::GetUnreachNode() const [member function]
    cls.add_method('GetUnreachNode', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::SetOriginalDst(ns3::Ipv4Address originalDst) [member function]
    cls.add_method('SetOriginalDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originalDst')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnreachHeader::SetUnreachNode(ns3::Ipv4Address unreachNode) [member function]
    cls.add_method('SetUnreachNode', 
                   'void', 
                   [param('ns3::Ipv4Address', 'unreachNode')])
    return

def register_Ns3YoungdsrYoungdsrOptionRerrUnsupportHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::YoungdsrOptionRerrUnsupportHeader(ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::YoungdsrOptionRerrUnsupportHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetErrorDst() const [member function]
    cls.add_method('GetErrorDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetErrorSrc() const [member function]
    cls.add_method('GetErrorSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::GetUnsupported() const [member function]
    cls.add_method('GetUnsupported', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::SetErrorDst(ns3::Ipv4Address errorDstAddress) [member function]
    cls.add_method('SetErrorDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorDstAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::SetErrorSrc(ns3::Ipv4Address errorSrcAddress) [member function]
    cls.add_method('SetErrorSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrcAddress')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRerrUnsupportHeader::SetUnsupported(uint16_t optionType) [member function]
    cls.add_method('SetUnsupported', 
                   'void', 
                   [param('uint16_t', 'optionType')])
    return

def register_Ns3YoungdsrYoungdsrOptionRrepHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrepHeader::YoungdsrOptionRrepHeader(ns3::youngdsr::YoungdsrOptionRrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRrepHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrepHeader::YoungdsrOptionRrepHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionRrepHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRrepHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::youngdsr::YoungdsrOptionRrepHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRrepHeader::GetTargetAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) const [member function]
    cls.add_method('GetTargetAddress', 
                   'ns3::Ipv4Address', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRrepHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRrepHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRrepHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    return

def register_Ns3YoungdsrYoungdsrOptionRreqHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreqHeader::YoungdsrOptionRreqHeader(ns3::youngdsr::YoungdsrOptionRreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRreqHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreqHeader::YoungdsrOptionRreqHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::AddNodeAddress(ns3::Ipv4Address ipv4) [member function]
    cls.add_method('AddNodeAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'ipv4')])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionRreqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrOptionRreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRreqHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::youngdsr::YoungdsrOptionRreqHeader::GetNodesAddresses() const [member function]
    cls.add_method('GetNodesAddresses', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRreqHeader::GetNodesNumber() const [member function]
    cls.add_method('GetNodesNumber', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionRreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionRreqHeader::GetTarget() [member function]
    cls.add_method('GetTarget', 
                   'ns3::Ipv4Address', 
                   [])
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::SetId(uint16_t identification) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionRreqHeader::SetTarget(ns3::Ipv4Address target) [member function]
    cls.add_method('SetTarget', 
                   'void', 
                   [param('ns3::Ipv4Address', 'target')])
    return

def register_Ns3YoungdsrYoungdsrOptionSRHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSRHeader::YoungdsrOptionSRHeader(ns3::youngdsr::YoungdsrOptionSRHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionSRHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSRHeader::YoungdsrOptionSRHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionSRHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionSRHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionSRHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionSRHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionSRHeader::GetNodeListSize() const [member function]
    cls.add_method('GetNodeListSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::youngdsr::YoungdsrOptionSRHeader::GetNodesAddress() const [member function]
    cls.add_method('GetNodesAddress', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionSRHeader::GetSalvage() const [member function]
    cls.add_method('GetSalvage', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionSRHeader::GetSegmentsLeft() const [member function]
    cls.add_method('GetSegmentsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionSRHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionSRHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::SetSalvage(uint8_t salvage) [member function]
    cls.add_method('SetSalvage', 
                   'void', 
                   [param('uint8_t', 'salvage')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionSRHeader::SetSegmentsLeft(uint8_t segmentsLeft) [member function]
    cls.add_method('SetSegmentsLeft', 
                   'void', 
                   [param('uint8_t', 'segmentsLeft')])
    return

def register_Ns3YoungdsrYoungdsrOptions_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptions::YoungdsrOptions(ns3::youngdsr::YoungdsrOptions const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptions const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptions::YoungdsrOptions() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrOptions::CheckDuplicates(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('CheckDuplicates', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrOptions::ContainAddressAfter(ns3::Ipv4Address ipv4Address, ns3::Ipv4Address destAddress, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    ...
    ## youngdsr-options.h (module 'youngdsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::youngdsr::YoungdsrOptions::CutRoute(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList) [member function]
    cls.add_method('CutRoute', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'nodeList')])
    ## youngdsr-options.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptions::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ptr<ns3::Node> ns3::youngdsr::YoungdsrOptions::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ptr<ns3::Node> ns3::youngdsr::YoungdsrOptions::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptions::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptions::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrOptions::IfDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec2) [member function]
    cls.add_method('IfDuplicates', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec'), param('std::vector< ns3::Ipv4Address > &', 'vec2')])
    ## youngdsr-options.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptions::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptions::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_pure_virtual=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptions::RemoveDuplicates(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('RemoveDuplicates', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrOptions::ReverseRoutes(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseRoutes', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptions::ReverseSearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptions::ReverseSearchNextTwoHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('ReverseSearchNextTwoHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptions::ScheduleReply(ns3::Ptr<ns3::Packet> & packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, ns3::Ipv4Address & source, ns3::Ipv4Address & destination) [member function]
    ...
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptions::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-options.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptions::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::youngdsr::YoungdsrOptions::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
...
def register_Ns3YoungdsrYoungdsrPassiveBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffEntry::YoungdsrPassiveBuffEntry(ns3::youngdsr::YoungdsrPassiveBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrPassiveBuffEntry const &', 'arg0')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffEntry::YoungdsrPassiveBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Ipv4Address s=ns3::Ipv4Address(), ns3::Ipv4Address n=ns3::Ipv4Address(), uint16_t i=0, uint16_t f=0, uint8_t seg=0, ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrPassiveBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrPassiveBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrPassiveBuffEntry::GetFragmentOffset() const [member function]
    cls.add_method('GetFragmentOffset', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrPassiveBuffEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrPassiveBuffEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Ptr<const ns3::Packet> ns3::youngdsr::YoungdsrPassiveBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrPassiveBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrPassiveBuffEntry::GetSegsLeft() const [member function]
    cls.add_method('GetSegsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrPassiveBuffEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetFragmentOffset(uint16_t f) [member function]
    cls.add_method('SetFragmentOffset', 
                   'void', 
                   [param('uint16_t', 'f')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetNextHop(ns3::Ipv4Address n) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'n')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetSegsLeft(uint8_t seg) [member function]
    cls.add_method('SetSegsLeft', 
                   'void', 
                   [param('uint8_t', 'seg')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3YoungdsrYoungdsrPassiveBuffer_methods(root_module, cls):
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffer::YoungdsrPassiveBuffer(ns3::youngdsr::YoungdsrPassiveBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrPassiveBuffer const &', 'arg0')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrPassiveBuffer::YoungdsrPassiveBuffer() [constructor]
    cls.add_constructor([])
    ## youngdsr-passive-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrPassiveBuffer::AllEqual(ns3::youngdsr::YoungdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('AllEqual', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrPassiveBuffEntry &', 'entry')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrPassiveBuffer::Dequeue(ns3::Ipv4Address dst, ns3::youngdsr::YoungdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::youngdsr::YoungdsrPassiveBuffEntry &', 'entry')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrPassiveBuffer::Enqueue(ns3::youngdsr::YoungdsrPassiveBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrPassiveBuffEntry &', 'entry')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrPassiveBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrPassiveBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrPassiveBuffer::GetPassiveBufferTimeout() const [member function]
    cls.add_method('GetPassiveBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrPassiveBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-passive-buff.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrPassiveBuffer::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## youngdsr-passive-buff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrPassiveBuffer::SetPassiveBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetPassiveBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3YoungdsrYoungdsrReceivedRreqEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrReceivedRreqEntry::YoungdsrReceivedRreqEntry(ns3::youngdsr::YoungdsrReceivedRreqEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrReceivedRreqEntry const &', 'arg0')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrReceivedRreqEntry::YoungdsrReceivedRreqEntry(ns3::Ipv4Address d=ns3::Ipv4Address(), uint16_t i=0) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'd', default_value='ns3::Ipv4Address()'), param('uint16_t', 'i', default_value='0')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrReceivedRreqEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrReceivedRreqEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrReceivedRreqEntry::GetIdentification() const [member function]
    cls.add_method('GetIdentification', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrReceivedRreqEntry::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrReceivedRreqEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrReceivedRreqEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrReceivedRreqEntry::SetIdentification(uint16_t i) [member function]
    cls.add_method('SetIdentification', 
                   'void', 
                   [param('uint16_t', 'i')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrReceivedRreqEntry::SetSource(ns3::Ipv4Address s) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 's')])
    return

def register_Ns3YoungdsrYoungdsrRouteCache_methods(root_module, cls):
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::YoungdsrRouteCache(ns3::youngdsr::YoungdsrRouteCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRouteCache const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::YoungdsrRouteCache() [constructor]
    cls.add_constructor([])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::AddArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::AddNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Ipv4Address ownAddress, ns3::Time expire) [member function]
    ...
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::AddRoute(ns3::youngdsr::YoungdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrRouteCacheEntry &', 'rt')])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::AddRoute_Link(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address node) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'node')])
    ## youngdsr-rcache.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrRouteCache::CheckUniqueAckId(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('CheckUniqueAckId', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::ClearMac() [member function]
    cls.add_method('ClearMac', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::DelArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    ...
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::FindSameRoute(ns3::youngdsr::YoungdsrRouteCacheEntry & rt, std::list<ns3::youngdsr::YoungdsrRouteCacheEntry, std::allocator<ns3::youngdsr::YoungdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('FindSameRoute', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrRouteCacheEntry &', 'rt'), param('std::list< ns3::youngdsr::YoungdsrRouteCacheEntry > &', 'rtVector')])
    ## youngdsr-rcache.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrRouteCache::GetAckSize() [member function]
    cls.add_method('GetAckSize', 
                   'uint16_t', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetCacheTimeout() const [member function]
    cls.add_method('GetCacheTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::youngdsr::YoungdsrRouteCache::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetInitStability() const [member function]
    cls.add_method('GetInitStability', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRouteCache::GetMaxCacheLen() const [member function]
    cls.add_method('GetMaxCacheLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRouteCache::GetMaxEntriesEachDst() const [member function]
    cls.add_method('GetMaxEntriesEachDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetMinLifeTime() const [member function]
    cls.add_method('GetMinLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): uint64_t ns3::youngdsr::YoungdsrRouteCache::GetStabilityDecrFactor() const [member function]
    cls.add_method('GetStabilityDecrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): uint64_t ns3::youngdsr::YoungdsrRouteCache::GetStabilityIncrFactor() const [member function]
    cls.add_method('GetStabilityIncrFactor', 
                   'uint64_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::GetSubRoute() const [member function]
    cls.add_method('GetSubRoute', 
                   'bool', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::youngdsr::YoungdsrRouteCache::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrRouteCache::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCache::GetUseExtends() const [member function]
    cls.add_method('GetUseExtends', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Mac48Address ns3::youngdsr::YoungdsrRouteCache::LookupMacAddress(ns3::Ipv4Address addr) [member function]
    cls.add_method('LookupMacAddress', 
                   'ns3::Mac48Address', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::LookupRoute(ns3::Ipv4Address id, ns3::youngdsr::YoungdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::youngdsr::YoungdsrRouteCacheEntry &', 'rt')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::Print(std::ostream & os) [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::PrintRouteVector(std::list<ns3::youngdsr::YoungdsrRouteCacheEntry, std::allocator<ns3::youngdsr::YoungdsrRouteCacheEntry> > route) [member function]
    cls.add_method('PrintRouteVector', 
                   'void', 
                   [param('std::list< ns3::youngdsr::YoungdsrRouteCacheEntry >', 'route')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::ProcessTxError(ns3::WifiMacHeader const & hdr) [member function]
    cls.add_method('ProcessTxError', 
                   'void', 
                   [param('ns3::WifiMacHeader const &', 'hdr')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::PurgeLinkNode() [member function]
    cls.add_method('PurgeLinkNode', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::PurgeMac() [member function]
    cls.add_method('PurgeMac', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::RebuildBestRouteTable(ns3::Ipv4Address source) [member function]
    cls.add_method('RebuildBestRouteTable', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::RemoveLastEntry(std::list<ns3::youngdsr::YoungdsrRouteCacheEntry, std::allocator<ns3::youngdsr::YoungdsrRouteCacheEntry> > & rtVector) [member function]
    cls.add_method('RemoveLastEntry', 
                   'void', 
                   [param('std::list< ns3::youngdsr::YoungdsrRouteCacheEntry > &', 'rtVector')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetCacheTimeout(ns3::Time t) [member function]
    cls.add_method('SetCacheTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetCacheType(std::string type) [member function]
    cls.add_method('SetCacheType', 
                   'void', 
                   [param('std::string', 'type')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetCallback(ns3::Callback<void, ns3::Ipv4Address, unsigned char, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetInitStability(ns3::Time initStability) [member function]
    cls.add_method('SetInitStability', 
                   'void', 
                   [param('ns3::Time', 'initStability')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetMaxCacheLen(uint32_t len) [member function]
    cls.add_method('SetMaxCacheLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetMaxEntriesEachDst(uint32_t entries) [member function]
    cls.add_method('SetMaxEntriesEachDst', 
                   'void', 
                   [param('uint32_t', 'entries')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetMinLifeTime(ns3::Time minLifeTime) [member function]
    cls.add_method('SetMinLifeTime', 
                   'void', 
                   [param('ns3::Time', 'minLifeTime')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetStabilityDecrFactor(uint64_t decrFactor) [member function]
    cls.add_method('SetStabilityDecrFactor', 
                   'void', 
                   [param('uint64_t', 'decrFactor')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetStabilityIncrFactor(uint64_t incrFactor) [member function]
    cls.add_method('SetStabilityIncrFactor', 
                   'void', 
                   [param('uint64_t', 'incrFactor')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetSubRoute(bool subRoute) [member function]
    cls.add_method('SetSubRoute', 
                   'void', 
                   [param('bool', 'subRoute')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::SetUseExtends(ns3::Time useExtends) [member function]
    cls.add_method('SetUseExtends', 
                   'void', 
                   [param('ns3::Time', 'useExtends')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::UpdateNeighbor(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > nodeList, ns3::Time expire) [member function]
    cls.add_method('UpdateNeighbor', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodeList'), param('ns3::Time', 'expire')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::UpdateNetGraph() [member function]
    cls.add_method('UpdateNetGraph', 
                   'void', 
                   [])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCache::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCache::UseExtends(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_arp [variable]
    cls.add_instance_attribute('m_arp', 'std::vector< ns3::Ptr< ns3::ArpCache > >', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_delay [variable]
    cls.add_instance_attribute('m_delay', 'ns3::Time', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_handleLinkFailure [variable]
    ...
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_nb [variable]
    cls.add_instance_attribute('m_nb', 'std::vector< ns3::youngdsr::YoungdsrRouteCache::Neighbor >', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_ntimer [variable]
    cls.add_instance_attribute('m_ntimer', 'ns3::Timer', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::m_txErrorCallback [variable]
...
def register_Ns3YoungdsrYoungdsrRouteCacheNeighbor_methods(root_module, cls):
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::Neighbor(ns3::youngdsr::YoungdsrRouteCache::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRouteCache::Neighbor const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::Neighbor() [constructor]
    cls.add_constructor([])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCache::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrYoungdsrRouteCacheEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCacheEntry::YoungdsrRouteCacheEntry(ns3::youngdsr::YoungdsrRouteCacheEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRouteCacheEntry const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCacheEntry::YoungdsrRouteCacheEntry(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR const & ip=::ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR( ), ns3::Ipv4Address dst=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR const &', 'ip', default_value='::ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR( )'), param('ns3::Ipv4Address', 'dst', default_value='ns3::Ipv4Address()'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCacheEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrRouteCacheEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrRouteCacheEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR ns3::youngdsr::YoungdsrRouteCacheEntry::GetVector() const [member function]
    cls.add_method('GetVector', 
                   'ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## youngdsr-rcache.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouteCacheEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouteCacheEntry::SetVector(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR v) [member function]
    cls.add_method('SetVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'v')])
    return

def register_Ns3YoungdsrYoungdsrRouting_methods(root_module, cls):
    ## youngdsr-routing.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouting::YoungdsrRouting(ns3::youngdsr::YoungdsrRouting const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRouting const &', 'arg0')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouting::YoungdsrRouting() [constructor]
    cls.add_constructor([])
    ## youngdsr-routing.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrRouting::AddAckReqHeader(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Address nextHop) [member function]
    cls.add_method('AddAckReqHeader', 
                   'uint16_t', 
                   [param('ns3::Ptr< ns3::Packet > &', 'packet'), param('ns3::Ipv4Address', 'nextHop')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::AddRoute(ns3::youngdsr::YoungdsrRouteCacheEntry & rt) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrRouteCacheEntry &', 'rt')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::AddRoute_Link(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR nodelist, ns3::Ipv4Address source) [member function]
    cls.add_method('AddRoute_Link', 
                   'bool', 
                   [param('std::vector< ns3::Ipv4Address >', 'nodelist'), param('ns3::Ipv4Address', 'source')])
    ## youngdsr-routing.h (module 'youngdsr'): int64_t ns3::youngdsr::YoungdsrRouting::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CallCancelPacketTimer(uint16_t ackId, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelLinkPacketTimer(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelLinkPacketTimer', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelNetworkPacketTimer(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelNetworkPacketTimer', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelPacketAllTimer(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPacketAllTimer', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelPacketTimerNextHop(ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('CancelPacketTimerNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelPassivePacketTimer(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb) [member function]
    cls.add_method('CancelPassivePacketTimer', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::CancelPassiveTimer(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CancelRreqTimer(ns3::Ipv4Address dst, bool isRemove) [member function]
    cls.add_method('CancelRreqTimer', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst'), param('bool', 'isRemove')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::CheckSendBuffer() [member function]
    cls.add_method('CheckSendBuffer', 
                   'void', 
                   [])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::DeleteAllRoutesIncludeLink(ns3::Ipv4Address errorSrc, ns3::Ipv4Address unreachNode, ns3::Ipv4Address node) [member function]
    cls.add_method('DeleteAllRoutesIncludeLink', 
                   'void', 
                   [param('ns3::Ipv4Address', 'errorSrc'), param('ns3::Ipv4Address', 'unreachNode'), param('ns3::Ipv4Address', 'node')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ForwardErrPacket(ns3::youngdsr::YoungdsrOptionRerrUnreachHeader & rerr, ns3::youngdsr::YoungdsrOptionSRHeader & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardErrPacket', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrOptionRerrUnreachHeader &', 'rerr'), param('ns3::youngdsr::YoungdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ForwardPacket(ns3::Ptr<const ns3::Packet> packet, ns3::youngdsr::YoungdsrOptionSRHeader & sourceRoute, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ipv4Address targetAddress, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('ForwardPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::youngdsr::YoungdsrOptionSRHeader &', 'sourceRoute'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('ns3::Ipv4Address', 'targetAddress'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::IpL4Protocol::DownTargetCallback ns3::youngdsr::YoungdsrRouting::GetDownTarget() const [member function]
    cls.add_method('GetDownTarget', 
                   'ns3::IpL4Protocol::DownTargetCallback', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): ns3::IpL4Protocol::DownTargetCallback6 ns3::youngdsr::YoungdsrRouting::GetDownTarget6() const [member function]
    cls.add_method('GetDownTarget6', 
                   'ns3::IpL4Protocol::DownTargetCallback6', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): std::vector<std::basic_string<char>, std::allocator<std::basic_string<char> > > ns3::youngdsr::YoungdsrRouting::GetElementsFromContext(std::string context) [member function]
    cls.add_method('GetElementsFromContext', 
                   'std::vector< std::string >', 
                   [param('std::string', 'context')])
    ## youngdsr-routing.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrRouting::GetIDfromIP(ns3::Ipv4Address address) [member function]
    cls.add_method('GetIDfromIP', 
                   'uint16_t', 
                   [param('ns3::Ipv4Address', 'address')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrRouting::GetIPfromID(uint16_t id) [member function]
    cls.add_method('GetIPfromID', 
                   'ns3::Ipv4Address', 
                   [param('uint16_t', 'id')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrRouting::GetIPfromMAC(ns3::Mac48Address address) [member function]
    cls.add_method('GetIPfromMAC', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Mac48Address', 'address')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::NetDevice> ns3::youngdsr::YoungdsrRouting::GetNetDeviceFromContext(std::string context) [member function]
    cls.add_method('GetNetDeviceFromContext', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('std::string', 'context')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::Node> ns3::youngdsr::YoungdsrRouting::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::Node> ns3::youngdsr::YoungdsrRouting::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::youngdsr::YoungdsrOptions> ns3::youngdsr::YoungdsrRouting::GetOption(int optionNumber) [member function]
    cls.add_method('GetOption', 
                   'ns3::Ptr< ns3::youngdsr::YoungdsrOptions >', 
                   [param('int', 'optionNumber')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::youngdsr::YoungdsrPassiveBuffer> ns3::youngdsr::YoungdsrRouting::GetPassiveBuffer() const [member function]
    cls.add_method('GetPassiveBuffer', 
                   'ns3::Ptr< ns3::youngdsr::YoungdsrPassiveBuffer >', 
                   [], 
                   is_const=True)
    ## youngdsr-routing.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRouting::GetPriority(ns3::youngdsr::YoungdsrMessageType messageType) [member function]
    cls.add_method('GetPriority', 
                   'uint32_t', 
                   [param('ns3::youngdsr::YoungdsrMessageType', 'messageType')])
    ## youngdsr-routing.h (module 'youngdsr'): int ns3::youngdsr::YoungdsrRouting::GetProtocolNumber() const [member function]
    cls.add_method('GetProtocolNumber', 
                   'int', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::youngdsr::YoungdsrRreqTable> ns3::youngdsr::YoungdsrRouting::GetRequestTable() const [member function]
    cls.add_method('GetRequestTable', 
                   'ns3::Ptr< ns3::youngdsr::YoungdsrRreqTable >', 
                   [], 
                   is_const=True)
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::youngdsr::YoungdsrRouteCache> ns3::youngdsr::YoungdsrRouting::GetRouteCache() const [member function]
    cls.add_method('GetRouteCache', 
                   'ns3::Ptr< ns3::youngdsr::YoungdsrRouteCache >', 
                   [], 
                   is_const=True)
    ## youngdsr-routing.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrRouting::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::IncreaseRetransTimer() [member function]
    cls.add_method('IncreaseRetransTimer', 
                   'void', 
                   [])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::Insert(ns3::Ptr<ns3::youngdsr::YoungdsrOptions> option) [member function]
    cls.add_method('Insert', 
                   'void', 
                   [param('ns3::Ptr< ns3::youngdsr::YoungdsrOptions >', 'option')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::IsLinkCache() [member function]
    cls.add_method('IsLinkCache', 
                   'bool', 
                   [])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::LinkScheduleTimerExpire(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('LinkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::LookupRoute(ns3::Ipv4Address id, ns3::youngdsr::YoungdsrRouteCacheEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::youngdsr::YoungdsrRouteCacheEntry &', 'rt')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::NetworkScheduleTimerExpire(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('NetworkScheduleTimerExpire', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::PacketNewRoute(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::PassiveEntryCheck(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t segsLeft, uint16_t fragmentOffset, uint16_t identification, bool saveEntry) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::PassiveScheduleTimerExpire(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('PassiveScheduleTimerExpire', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::PriorityScheduler(uint32_t priority, bool continueWithFirst) [member function]
    cls.add_method('PriorityScheduler', 
                   'void', 
                   [param('uint32_t', 'priority'), param('bool', 'continueWithFirst')])
    ## youngdsr-routing.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrRouting::Process(ns3::Ptr<ns3::Packet> & packet, ns3::Ipv4Header const & ipv4Header, ns3::Ipv4Address dst, uint8_t * nextHeader, uint8_t protocol, bool & isDropped) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
    ...
    ## youngdsr-routing.h (module 'youngdsr'): ns3::IpL4Protocol::RxStatus ns3::youngdsr::YoungdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::Ipv4Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::Ipv4Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): ns3::IpL4Protocol::RxStatus ns3::youngdsr::YoungdsrRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv6Header const & header, ns3::Ptr<ns3::Ipv6Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv6Header const &', 'header'), param('ns3::Ptr< ns3::Ipv6Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::RouteRequestTimerExpire(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SalvagePacket(ns3::Ptr<const ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address dst, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleCachedReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, ns3::Ptr<ns3::Ipv4Route> route, double hops) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleInitialReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleInterRequest(ns3::Ptr<ns3::Packet> packet) [member function]
    cls.add_method('ScheduleInterRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleLinkPacketRetry(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('ScheduleLinkPacketRetry', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleNetworkPacketRetry(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, bool isFirst, uint8_t protocol) [member function]
    cls.add_method('ScheduleNetworkPacketRetry', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('bool', 'isFirst'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SchedulePassivePacketRetry(ns3::youngdsr::YoungdsrMaintainBuffEntry & mb, uint8_t protocol) [member function]
    cls.add_method('SchedulePassivePacketRetry', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrMaintainBuffEntry &', 'mb'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::ScheduleRreqRetry(ns3::Ptr<ns3::Packet> packet, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > address, bool nonProp, uint32_t requestId, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::Scheduler(uint32_t priority) [member function]
    cls.add_method('Scheduler', 
                   'void', 
                   [param('uint32_t', 'priority')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrRouting::SearchNextHop(ns3::Ipv4Address ipv4Address, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('SearchNextHop', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'ipv4Address'), param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::Send(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('Send', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendAck(uint16_t ackId, ns3::Ipv4Address destination, ns3::Ipv4Address realSrc, ns3::Ipv4Address realDst, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendBuffTimerExpire() [member function]
    cls.add_method('SendBuffTimerExpire', 
                   'void', 
                   [])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendErrorRequest(ns3::youngdsr::YoungdsrOptionRerrUnreachHeader & rerr, uint8_t protocol) [member function]
    cls.add_method('SendErrorRequest', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrOptionRerrUnreachHeader &', 'rerr'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendGratuitousReply(ns3::Ipv4Address replyTo, ns3::Ipv4Address replyFrom, std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & nodeList, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendInitialRequest(ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol) [member function]
    cls.add_method('SendInitialRequest', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendPacket(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendPacketFromBuffer(ns3::youngdsr::YoungdsrOptionSRHeader const & sourceRoute, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacketFromBuffer', 
                   'void', 
                   [param('ns3::youngdsr::YoungdsrOptionSRHeader const &', 'sourceRoute'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::SendRealDown(ns3::youngdsr::YoungdsrNetworkQueueEntry & newEntry) [member function]
    cls.add_method('SendRealDown', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrNetworkQueueEntry &', 'newEntry')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendReply(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SendReply', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendRequest(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source) [member function]
    cls.add_method('SendRequest', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SendUnreachError(ns3::Ipv4Address unreachNode, ns3::Ipv4Address destination, ns3::Ipv4Address originalDst, uint8_t salvage, uint8_t protocol) [member function]
    ...
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetDownTarget(ns3::IpL4Protocol::DownTargetCallback callback) [member function]
    cls.add_method('SetDownTarget', 
                   'void', 
                   ...
                   is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetDownTarget6(ns3::IpL4Protocol::DownTargetCallback6 callback) [member function]
    cls.add_method('SetDownTarget6', 
                   'void', 
                   ...
                   is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetPassiveBuffer(ns3::Ptr<ns3::youngdsr::YoungdsrPassiveBuffer> r) [member function]
    cls.add_method('SetPassiveBuffer', 
                   'void', 
                   [param('ns3::Ptr< ns3::youngdsr::YoungdsrPassiveBuffer >', 'r')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetRequestTable(ns3::Ptr<ns3::youngdsr::YoungdsrRreqTable> r) [member function]
    cls.add_method('SetRequestTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::youngdsr::YoungdsrRreqTable >', 'r')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::Ptr<ns3::Ipv4Route> ns3::youngdsr::YoungdsrRouting::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
    cls.add_method('SetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ipv4Address', 'srcAddress')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::SetRouteCache(ns3::Ptr<ns3::youngdsr::YoungdsrRouteCache> r) [member function]
    cls.add_method('SetRouteCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::youngdsr::YoungdsrRouteCache >', 'r')])
    ## youngdsr-routing.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRouting::UpdateRouteEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('UpdateRouteEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::UseExtends(ns3::youngdsr::YoungdsrRouteCacheEntry::IP_VECTOR rt) [member function]
    cls.add_method('UseExtends', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'rt')])
    ## youngdsr-routing.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRouting::PROT_NUMBER [variable]
    cls.add_static_attribute('PROT_NUMBER', 'uint8_t const', is_const=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## youngdsr-routing.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRouting::NotifyNewAggregate() [member function]
    cls.add_method('NotifyNewAggregate', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3YoungdsrYoungdsrRoutingHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRoutingHeader::YoungdsrRoutingHeader(ns3::youngdsr::YoungdsrRoutingHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRoutingHeader const &', 'arg0')])
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRoutingHeader::YoungdsrRoutingHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRoutingHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrRoutingHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRoutingHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrRoutingHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRoutingHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-fs-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRoutingHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3YoungdsrYoungdsrRreqTable_methods(root_module, cls):
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRreqTable::YoungdsrRreqTable(ns3::youngdsr::YoungdsrRreqTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrRreqTable const &', 'arg0')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::YoungdsrRreqTable::YoungdsrRreqTable() [constructor]
    cls.add_constructor([])
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::CheckUniqueRreqId(ns3::Ipv4Address dst) [member function]
    cls.add_method('CheckUniqueRreqId', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::FindAndUpdate(ns3::Ipv4Address dst) [member function]
    cls.add_method('FindAndUpdate', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRreqTable::FindSourceEntry(ns3::Ipv4Address src, ns3::Ipv4Address dst, uint16_t id) [member function]
    cls.add_method('FindSourceEntry', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'src'), param('ns3::Ipv4Address', 'dst'), param('uint16_t', 'id')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::BlackList * ns3::youngdsr::YoungdsrRreqTable::FindUnidirectional(ns3::Ipv4Address neighbor) [member function]
    cls.add_method('FindUnidirectional', 
                   'ns3::youngdsr::BlackList *', 
                   [param('ns3::Ipv4Address', 'neighbor')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetInitHopLimit() const [member function]
    cls.add_method('GetInitHopLimit', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetRreqCnt(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetRreqCnt', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetRreqIdSize() const [member function]
    cls.add_method('GetRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetRreqSize() [member function]
    cls.add_method('GetRreqSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetRreqTableSize() const [member function]
    cls.add_method('GetRreqTableSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrRreqTable::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrRreqTable::GetUniqueRreqIdSize() const [member function]
    cls.add_method('GetUniqueRreqIdSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::Invalidate() [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [])
    ## youngdsr-rreq-table.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrRreqTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::PurgeNeighbor() [member function]
    cls.add_method('PurgeNeighbor', 
                   'void', 
                   [])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::RemoveLeastExpire() [member function]
    cls.add_method('RemoveLeastExpire', 
                   'void', 
                   [])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::RemoveRreqEntry(ns3::Ipv4Address dst) [member function]
    cls.add_method('RemoveRreqEntry', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::SetInitHopLimit(uint32_t hl) [member function]
    cls.add_method('SetInitHopLimit', 
                   'void', 
                   [param('uint32_t', 'hl')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::SetRreqIdSize(uint32_t id) [member function]
    cls.add_method('SetRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::SetRreqTableSize(uint32_t rt) [member function]
    cls.add_method('SetRreqTableSize', 
                   'void', 
                   [param('uint32_t', 'rt')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrRreqTable::SetUniqueRreqIdSize(uint32_t uid) [member function]
    cls.add_method('SetUniqueRreqIdSize', 
                   'void', 
                   [param('uint32_t', 'uid')])
    return

def register_Ns3YoungdsrYoungdsrSendBuffEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffEntry::YoungdsrSendBuffEntry(ns3::youngdsr::YoungdsrSendBuffEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrSendBuffEntry const &', 'arg0')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffEntry::YoungdsrSendBuffEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Address d=ns3::Ipv4Address(), ns3::Time exp=ns3::Simulator::Now(), uint8_t p=0) [constructor]
    ...
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrSendBuffEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrSendBuffEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::Ptr<const ns3::Packet> ns3::youngdsr::YoungdsrSendBuffEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrSendBuffEntry::GetProtocol() const [member function]
    cls.add_method('GetProtocol', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffEntry::SetDestination(ns3::Ipv4Address d) [member function]
    cls.add_method('SetDestination', 
                   'void', 
                   [param('ns3::Ipv4Address', 'd')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffEntry::SetProtocol(uint8_t p) [member function]
    cls.add_method('SetProtocol', 
                   'void', 
                   [param('uint8_t', 'p')])
    return

def register_Ns3YoungdsrYoungdsrSendBuffer_methods(root_module, cls):
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffer::YoungdsrSendBuffer(ns3::youngdsr::YoungdsrSendBuffer const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrSendBuffer const &', 'arg0')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::youngdsr::YoungdsrSendBuffer::YoungdsrSendBuffer() [constructor]
    cls.add_constructor([])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrSendBuffer::Dequeue(ns3::Ipv4Address dst, ns3::youngdsr::YoungdsrSendBuffEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::youngdsr::YoungdsrSendBuffEntry &', 'entry')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffer::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrSendBuffer::Enqueue(ns3::youngdsr::YoungdsrSendBuffEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::youngdsr::YoungdsrSendBuffEntry &', 'entry')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): bool ns3::youngdsr::YoungdsrSendBuffer::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): std::vector<ns3::youngdsr::YoungdsrSendBuffEntry, std::allocator<ns3::youngdsr::YoungdsrSendBuffEntry> > & ns3::youngdsr::YoungdsrSendBuffer::GetBuffer() [member function]
    cls.add_method('GetBuffer', 
                   'std::vector< ns3::youngdsr::YoungdsrSendBuffEntry > &', 
                   [])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrSendBuffer::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): ns3::Time ns3::youngdsr::YoungdsrSendBuffer::GetSendBufferTimeout() const [member function]
    cls.add_method('GetSendBufferTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## youngdsr-rsendbuff.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrSendBuffer::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffer::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## youngdsr-rsendbuff.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrSendBuffer::SetSendBufferTimeout(ns3::Time t) [member function]
    cls.add_method('SetSendBufferTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3YoungdsrGraReplyEntry_methods(root_module, cls):
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry::GraReplyEntry(ns3::youngdsr::GraReplyEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::GraReplyEntry const &', 'arg0')])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry::GraReplyEntry(ns3::Ipv4Address t, ns3::Ipv4Address f, ns3::Time h) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 't'), param('ns3::Ipv4Address', 'f'), param('ns3::Time', 'h')])
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry::m_gratReplyHoldoff [variable]
    cls.add_instance_attribute('m_gratReplyHoldoff', 'ns3::Time', is_const=False)
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry::m_hearFrom [variable]
    cls.add_instance_attribute('m_hearFrom', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-gratuitous-reply-table.h (module 'youngdsr'): ns3::youngdsr::GraReplyEntry::m_replyTo [variable]
    cls.add_instance_attribute('m_replyTo', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrLink_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::Link::Link(ns3::youngdsr::Link const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::Link const &', 'arg0')])
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::Link::Link(ns3::Ipv4Address ip1, ns3::Ipv4Address ip2) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip1'), param('ns3::Ipv4Address', 'ip2')])
    ## youngdsr-rcache.h (module 'youngdsr'): void ns3::youngdsr::Link::Print() const [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_const=True)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::Link::m_high [variable]
    cls.add_instance_attribute('m_high', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-rcache.h (module 'youngdsr'): ns3::youngdsr::Link::m_low [variable]
    cls.add_instance_attribute('m_low', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrLinkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::LinkKey() [constructor]
    cls.add_constructor([])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::LinkKey(ns3::youngdsr::LinkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::LinkKey const &', 'arg0')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::LinkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrNetworkKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::NetworkKey() [constructor]
    cls.add_constructor([])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::NetworkKey(ns3::youngdsr::NetworkKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::NetworkKey const &', 'arg0')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::m_nextHop [variable]
    cls.add_instance_attribute('m_nextHop', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::m_ourAdd [variable]
    cls.add_instance_attribute('m_ourAdd', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::NetworkKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrPassiveKey_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::PassiveKey() [constructor]
    cls.add_constructor([])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::PassiveKey(ns3::youngdsr::PassiveKey const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::PassiveKey const &', 'arg0')])
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::m_ackId [variable]
    cls.add_instance_attribute('m_ackId', 'uint16_t', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::m_destination [variable]
    cls.add_instance_attribute('m_destination', 'ns3::Ipv4Address', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::m_segsLeft [variable]
    cls.add_instance_attribute('m_segsLeft', 'uint8_t', is_const=False)
    ## youngdsr-maintain-buff.h (module 'youngdsr'): ns3::youngdsr::PassiveKey::m_source [variable]
    cls.add_instance_attribute('m_source', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3YoungdsrRreqTableEntry_methods(root_module, cls):
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::RreqTableEntry::RreqTableEntry() [constructor]
    cls.add_constructor([])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::RreqTableEntry::RreqTableEntry(ns3::youngdsr::RreqTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::RreqTableEntry const &', 'arg0')])
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::RreqTableEntry::m_expire [variable]
    cls.add_instance_attribute('m_expire', 'ns3::Time', is_const=False)
    ## youngdsr-rreq-table.h (module 'youngdsr'): ns3::youngdsr::RreqTableEntry::m_reqNo [variable]
    cls.add_instance_attribute('m_reqNo', 'uint32_t', is_const=False)
    return

def register_Ns3YoungdsrYoungdsrOptionAck_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAck::YoungdsrOptionAck(ns3::youngdsr::YoungdsrOptionAck const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionAck const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAck::YoungdsrOptionAck() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionAck::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionAck::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionAck::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionAck::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAck::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionAckHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckHeader::YoungdsrOptionAckHeader(ns3::youngdsr::YoungdsrOptionAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionAckHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckHeader::YoungdsrOptionAckHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrOptionAckHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionAckHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionAckHeader::GetRealDst() const [member function]
    cls.add_method('GetRealDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::Ipv4Address ns3::youngdsr::YoungdsrOptionAckHeader::GetRealSrc() const [member function]
    cls.add_method('GetRealSrc', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckHeader::SetRealDst(ns3::Ipv4Address realDstAddress) [member function]
    cls.add_method('SetRealDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realDstAddress')])
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckHeader::SetRealSrc(ns3::Ipv4Address realSrcAddress) [member function]
    cls.add_method('SetRealSrc', 
                   'void', 
                   [param('ns3::Ipv4Address', 'realSrcAddress')])
    return

def register_Ns3YoungdsrYoungdsrOptionAckReq_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReq::YoungdsrOptionAckReq(ns3::youngdsr::YoungdsrOptionAckReq const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionAckReq const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReq::YoungdsrOptionAckReq() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionAckReq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionAckReq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionAckReq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionAckReq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionAckReqHeader_methods(root_module, cls):
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReqHeader::YoungdsrOptionAckReqHeader(ns3::youngdsr::YoungdsrOptionAckReqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionAckReqHeader const &', 'arg0')])
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionAckReqHeader::YoungdsrOptionAckReqHeader() [constructor]
    cls.add_constructor([])
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionAckReqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint16_t ns3::youngdsr::YoungdsrOptionAckReqHeader::GetAckId() const [member function]
    cls.add_method('GetAckId', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionHeader::Alignment ns3::youngdsr::YoungdsrOptionAckReqHeader::GetAlignment() const [member function]
    cls.add_method('GetAlignment', 
                   'ns3::youngdsr::YoungdsrOptionHeader::Alignment', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionAckReqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): uint32_t ns3::youngdsr::YoungdsrOptionAckReqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionAckReqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckReqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckReqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## youngdsr-option-header.h (module 'youngdsr'): void ns3::youngdsr::YoungdsrOptionAckReqHeader::SetAckId(uint16_t identification) [member function]
    cls.add_method('SetAckId', 
                   'void', 
                   [param('uint16_t', 'identification')])
    return

def register_Ns3YoungdsrYoungdsrOptionPad1_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1::YoungdsrOptionPad1(ns3::youngdsr::YoungdsrOptionPad1 const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionPad1 const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1::YoungdsrOptionPad1() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionPad1::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionPad1::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionPad1::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPad1::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionPadn_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadn::YoungdsrOptionPadn(ns3::youngdsr::YoungdsrOptionPadn const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionPadn const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadn::YoungdsrOptionPadn() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionPadn::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionPadn::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionPadn::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionPadn::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionRerr_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerr::YoungdsrOptionRerr(ns3::youngdsr::YoungdsrOptionRerr const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRerr const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerr::YoungdsrOptionRerr() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerr::DoSendError(ns3::Ptr<ns3::Packet> p, ns3::youngdsr::YoungdsrOptionRerrUnreachHeader & rerr, uint32_t rerrSize, ns3::Ipv4Address ipv4Address, uint8_t protocol) [member function]
    cls.add_method('DoSendError', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::youngdsr::YoungdsrOptionRerrUnreachHeader &', 'rerr'), param('uint32_t', 'rerrSize'), param('ns3::Ipv4Address', 'ipv4Address'), param('uint8_t', 'protocol')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRerr::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerr::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRerr::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRerr::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRerr::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionRrep_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrep::YoungdsrOptionRrep(ns3::youngdsr::YoungdsrOptionRrep const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRrep const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrep::YoungdsrOptionRrep() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRrep::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRrep::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRrep::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRrep::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRrep::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionRreq_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreq::YoungdsrOptionRreq(ns3::youngdsr::YoungdsrOptionRreq const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionRreq const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreq::YoungdsrOptionRreq() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionRreq::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRreq::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionRreq::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionRreq::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionRreq::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return

def register_Ns3YoungdsrYoungdsrOptionSR_methods(root_module, cls):
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSR::YoungdsrOptionSR(ns3::youngdsr::YoungdsrOptionSR const & arg0) [constructor]
    cls.add_constructor([param('ns3::youngdsr::YoungdsrOptionSR const &', 'arg0')])
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSR::YoungdsrOptionSR() [constructor]
    cls.add_constructor([])
    ## youngdsr-options.h (module 'youngdsr'): ns3::TypeId ns3::youngdsr::YoungdsrOptionSR::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionSR::GetOptionNumber() const [member function]
    cls.add_method('GetOptionNumber', 
                   'uint8_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): static ns3::TypeId ns3::youngdsr::YoungdsrOptionSR::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## youngdsr-options.h (module 'youngdsr'): uint8_t ns3::youngdsr::YoungdsrOptionSR::Process(ns3::Ptr<ns3::Packet> packet, ns3::Ptr<ns3::Packet> youngdsrP, ns3::Ipv4Address ipv4Address, ns3::Ipv4Address source, ns3::Ipv4Header const & ipv4Header, uint8_t protocol, bool & isPromisc, ns3::Ipv4Address promiscSource) [member function]
    cls.add_method('Process', 
                   'uint8_t', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ptr< ns3::Packet >', 'youngdsrP'), param('ns3::Ipv4Address', 'ipv4Address'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Header const &', 'ipv4Header'), param('uint8_t', 'protocol'), param('bool &', 'isPromisc'), param('ns3::Ipv4Address', 'promiscSource')], 
                   is_virtual=True)
    ## youngdsr-options.h (module 'youngdsr'): ns3::youngdsr::YoungdsrOptionSR::OPT_NUMBER [variable]
    cls.add_static_attribute('OPT_NUMBER', 'uint8_t const', is_const=True)
    return
...
def register_functions(root_module):
    ...
    register_functions_ns3_youngdsr(module.add_cpp_namespace('youngdsr'), root_module)
...
def register_functions_ns3_youngdsr(module, root_module):
    return
