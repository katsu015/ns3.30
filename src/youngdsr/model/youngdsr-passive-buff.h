 ...
 */
class YoungdsrPassiveBuffEntry
{
public:
  /**
   * Construct a YoungdsrPassiveBuffEntry with the given parameters
   *
   * \param pa packet
   ...
   */
  YoungdsrPassiveBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (), Ipv4Address s = Ipv4Address (),
   ...
   */
  bool operator== (YoungdsrPassiveBuffEntry const & o) const
  {
...
/**
 * \ingroup youngdsr
 * \class YoungdsrPassiveBuffer
 * \brief DSR passive buffer
 */
/************************************************************************************************************************/
class YoungdsrPassiveBuffer  : public Object
{
public:
  /**
 ...
 /// \return true if an Entry was found and removed.
  bool AllEqual (YoungdsrPassiveBuffEntry & entry);
  /// Number of entries
...
private:
  ...
  std::vector<YoungdsrPassiveBuffEntry> m_passiveBuffer;
  /// Remove all expired entries
  void Purge ();
  /// Notify that packet is dropped from queue by timeout
  /// \param en BuffEntry Buffer entry
  /// \param reason Drop reason
  void Drop (YoungdsrPassiveBuffEntry en, std::string reason);
  /// Notify that packet is dropped from queue by timeout
  /// \param en BuffEntry Buffer entry
  /// \param reason Drop reason
  void DropLink (YoungdsrPassiveBuffEntry en, std::string reason);
  ...
  static bool LinkEqual (YoungdsrPassiveBuffEntry en, const std::vector<Ipv4Address> link)
  {
