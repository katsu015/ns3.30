 ...
 */
class YoungdsrMaintainBuffEntry
{
public:
  /**
   * Construct a YoungdsrMaintainBuffEntry with the given parameters
   *
   * \param pa packet
   ...
   */
  YoungdsrMaintainBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address us = Ipv4Address (),
...
public:
  ...
  bool AllEqual (YoungdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for link ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool LinkEqual (YoungdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for network ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool NetworkEqual (YoungdsrMaintainBuffEntry & entry);
  /// Verify if the maintain buffer entry is the same in every field for promiscuous ack
  /// \param entry The Entry to check
  /// \return true if an Entry was found and removed.
  bool PromiscEqual (YoungdsrMaintainBuffEntry & entry);

private:
  /// The vector of maintain buffer entries
  std::vector<YoungdsrMaintainBuffEntry> m_maintainBuffer;
  ...
  static bool IsEqual (YoungdsrMaintainBuffEntry en, const Ipv4Address nextHop)
  {
