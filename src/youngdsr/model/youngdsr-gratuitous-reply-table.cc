...
NS_LOG_COMPONENT_DEFINE ("YoungdsrGraReplyTable");

namespace youngdsr {

NS_OBJECT_ENSURE_REGISTERED (YoungdsrGraReply);

TypeId YoungdsrGraReply::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::youngdsr::YoungdsrGraReply")
    .SetParent<Object> ()
    .SetGroupName ("Youngdsr")
    .AddConstructor<YoungdsrGraReply> ()
  ;
  return tid;
}

YoungdsrGraReply::YoungdsrGraReply ()
{
}
...
bool
YoungdsrGraReply::FindAndUpdate (Ipv4Address replyTo, Ipv4Address replyFrom, Time gratReplyHoldoff)
{
...
bool
YoungdsrGraReply::AddEntry (GraReplyEntry & graTableEntry)
{
