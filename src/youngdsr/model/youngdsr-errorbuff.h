 ...
 */
class YoungdsrErrorBuffEntry
{
public:
  /**
   * Create an YoungdsrErrorBuffEntry with the given parameters.
   *
   * \param pa packet
   ...
   */
  YoungdsrErrorBuffEntry (Ptr<const Packet> pa = 0, Ipv4Address d = Ipv4Address (), Ipv4Address s = Ipv4Address (),
   ...
   * \param o another YoungdsrErrorBuffEntry
   * \return true if equal
   */
  bool operator== (YoungdsrErrorBuffEntry const & o) const
  {
...
public:
   ...
   */
  bool Enqueue (YoungdsrErrorBuffEntry & entry);
  /**
   ...
   */
  bool Dequeue (Ipv4Address dst, YoungdsrErrorBuffEntry & entry);
  /**
   ...
   */
  std::vector<YoungdsrErrorBuffEntry> & GetBuffer ()
  {
...
private:
  ...
  std::vector<YoungdsrErrorBuffEntry> m_errorBuffer;
   ...
   */
  ///
  void Drop (YoungdsrErrorBuffEntry en, std::string reason);
  /**
   * Notify that packet is dropped from queue by link error
   * \param en Error Buffer Entry
   * \param reason Drop reason.
   */
  void DropLink (YoungdsrErrorBuffEntry en, std::string reason);
   ...
   */
  ///
  static bool LinkEqual (YoungdsrErrorBuffEntry en, const std::vector<Ipv4Address> link)
  {
